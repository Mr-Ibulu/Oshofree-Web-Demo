...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between space-x-2 rounded-md border border-sky-700 bg-white px-3 py-2 text-sm font-semibold ring-offset-white placeholder:text-neutral-500 focus:outline-none focus:ring-2 disabled:cursor-not-allowed disabled:opacity-50",
      className,
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <MdOutlineKeyboardArrowDown className="text-xl text-sky-700 opacity-70" />
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <MdCheck className="text-xl text-sky-700" />
      </SelectPrimitive.ItemIndicator>
    </span>
